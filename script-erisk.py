...
with open("datasets-MH/eRisk17-ujjwal/eRisk_X_train.pkl", "rb") as f:
    X_train = pickle.load(f)

# Load data from pickle file
with open("datasets-MH/eRisk17-ujjwal/eRisk_X_test.pkl", "rb") as f:
    X_test = pickle.load(f)

# Load data from pickle file
with open("datasets-MH/eRisk17-ujjwal/eRisk_y_train.pkl", "rb") as f:
    y_train = pickle.load(f)

# Load data from pickle file
with open("datasets-MH/eRisk17-ujjwal/eRisk_y_test.pkl", "rb") as f:
...
with open("erisk-logs-small.txt", "w+") as f:
    for epoch in range(num_epochs):
        ...
        if loss < minLoss:
            ...
            torch.save(model.state_dict(), f"erisk-UnifiedQA-small-bestModel.pt")
            minLoss = loss
