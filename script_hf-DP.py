...
state_dict = torch.load("hface-UnifiedQA-small-bestModel.pt")
...
with open("hf-logs-small-DP.txt", "w+") as f:
    for epoch in range(num_epochs):
        ...
        if loss < minLoss:
            ...
            torch.save(model.state_dict(), f"hf-UnifiedQA-small-DP-bestModel.pt")
            minLoss = loss
